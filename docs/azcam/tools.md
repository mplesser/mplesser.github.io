...
[Documentation for the base Exposure class](https://mplesser.github.io/docs/azcam/tools/exposure.html)
...
[Documentation for the base Controller class](https://mplesser.github.io/docs/azcam/tools/controller.html)
